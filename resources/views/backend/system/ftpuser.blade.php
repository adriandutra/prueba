		...
		<div class="dropdown" style="">
			...
			<ul class="dropdown-menu drop-actions">
				...
				<div class="panel-body">
						...
						data-toggle="table" 
						data-url="{{url('api/v1/users/ftpuser') }}"  
						...
						data-cookie="true"
						 ...
						 ><thead>
						    ...
						    <!-- END list_show -->
						        ...
						        <th data-field="userid"  data-sortable="true" data-align="center">Usuario</th>
						     
						     	<th data-field="homedir" data-sortable="true" data-align="center">Directortio</th>
						   
						        <th data-field="accessed" data-sortable="true" data-formatter="datelabel" data-align="center">Acceso</th>
						           
						        <th data-field="modified" data-sortable="true" data-formatter="datelabel" data-align="center">Modifico</th>
						        <!-- BEGIN edit_show -->
